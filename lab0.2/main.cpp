...
void rectangle::Add()
{
    double addx1, addx2, addy1, addy2;
    Result();
    cout << "На сколько изменить координату х левой нижней точки: " << endl; cin >> addx1;
    x1 += addx1;
    cout << "На сколько изменить координату y левой нижней точки: " << endl; cin >> addy2;
    y2 += addy2;
    cout << "На сколько изменить координату х правой верхней точки: " << endl; cin >> addx2;
    x2 += addx2;
    cout << "На сколько изменить координату y правой верхней точки: " << endl; cin >> addy1;
    y1 += addy1;
    Result();
}
...
constexpr long double operator"" _tometers(long double aCm)
{
    return aCm / 100;
}

constexpr long double operator"" _tokilometers(long double aCm)
{
    return aCm / 1000;
}
...
int main()
{
    ...
    cout << " 1 - Ввод данных \n 2 - Вывод \n 3 - Перемещение \n 4 - Изменение размера\n"
        ...
        " + - Добавить к координатам (Перегрузка операторов) \n 0 - Выход\n" << endl;
    rectangle A;
    char Control;
    cout << "> ";
    cin >> Control;
    ...
    std::cout << "The example of using to-meters literal is: " << 100.0_tometers << std::endl;
    std::cout << "The example of using to-kilometers literal is: " << 1000.0_tokilometers << std::endl;
